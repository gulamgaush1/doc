  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-800">Add New Patient</h1>
          <p className="text-neutral-600">Create a new patient record</p>
        </div>
        <div className="mt-4 sm:mt-0 flex space-x-2">
          <Link to="/patients" className="btn btn-outline flex items-center">
